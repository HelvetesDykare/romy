-- Emilie one-shot schema
-- Fresh Postgres database (no Supabase auth dependency).
-- Auth is handled by the application layer (JWT + bcrypt).
-- Run this once on a new database. Existing deployments apply incremental migrations.

create extension if not exists "pgcrypto";

-- ---------------------------------------------------------------------------
-- Users (application-managed auth)
-- ---------------------------------------------------------------------------
